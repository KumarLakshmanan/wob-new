...
class BrandOfferDetails extends StatefulWidget {
  final String title;
  final String subtitle;
  final String image;
  final String percent;
  final Color color;
  const BrandOfferDetails({
    Key? key,
    required this.title,
...
class _StoreOfeerDetailsState extends State<BrandOfferDetails> {
  @override
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.headline4!.copyWith(
                      color: Get.isDarkMode ? design.dark.textcolor : design.light.textcolor),
                ),
              ),
              BulletedList(
                listItems: [
