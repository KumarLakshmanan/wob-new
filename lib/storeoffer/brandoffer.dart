...
class BrandOffer extends StatefulWidget {
  const BrandOffer({Key? key}) : super(key: key);

  @override
  BrandOfferState createState() => BrandOfferState();
}

class BrandOfferState extends State<BrandOffer> {
  @override
